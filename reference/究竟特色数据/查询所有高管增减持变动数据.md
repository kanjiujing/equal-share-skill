...
| `startDate` | `str` | 否 | - | 开始时间，如果开始时间和结束时间都不传，默认按照日期倒序，给最新的20条；，(格式为yyyy-MM-dd，可指定查询具体日期) |
| `endDate` | `str` | 否 | - | 结束时间 如果开始时间和结束时间都不传，默认按照日期倒序，给最新的20条；，(格式为yyyy-MM-dd，可指定查询具体日期) |
